  ...
  describe('getAll', () => {
    it('should return an array of galleries', () => {
      const galleries: IGallery[] = [
        { id: '1', name: 'Gallery 1', location: 'Location 1', image: 'Image 1' },
        { id: '2', name: 'Gallery 2', location: 'Location 2', image: 'Image 2' }
      ];
